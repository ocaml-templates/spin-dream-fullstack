          ...
          <div class="flex-grow flex flex-col justify-center p-12">
            <div class="md:pl-16 pl-0">
              ...
              <p class="sm:text-xl text-gray-600 mt-3 leading-relaxed">
                ...
                <span class="font-mono bg-gray-200 text-sm sm:text-base text-gray-700 subpixel-antialiased px-1 rounded">app_template.html.ml</span>
                file located in the <span class="font-mono bg-gray-200 text-sm sm:text-base text-gray-700 subpixel-antialiased px-1 rounded">lib/{{ project_snake }}_web/templates/</span> directory. If you used <span class="font-mono bg-gray-200 text-sm sm:text-base text-gray-700 subpixel-antialiased px-1 rounded">make watch</span> to view this page, try editing that file and refresh this page to see your changes.
              </p>
              <p class="mt-3">
                <a href="/app" class="text-sm font-medium text-indigo-600 hover:text-indigo-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                  >Go to the JavaScript application
